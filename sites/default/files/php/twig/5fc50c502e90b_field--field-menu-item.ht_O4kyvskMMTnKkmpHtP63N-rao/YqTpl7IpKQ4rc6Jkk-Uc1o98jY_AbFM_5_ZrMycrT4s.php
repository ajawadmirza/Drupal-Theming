...
/* themes/etisalat/templates/common/field--field-menu-item.html.twig */
class __TwigTemplate_a72a84d434a8267597963b44b2c334a5f808ba5df273e67d21d05ffd16763a6b extends \Twig\Template
{
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 65
                    echo "      <div";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "field__item quick-links-list collapse links-item"], "method")), "html", null, true);
                    echo ">";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "content", [])), "html", null, true);
                    echo "</div>
    ";
...
";
    ...
    {
        return "themes/etisalat/templates/common/field--field-menu-item.html.twig";
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
      <div{{ attributes.addClass(classes, 'field__item quick-links-list collapse links-item') }}>{{ item.content }}</div>
    {% endfor %}
  {% endif %}
{% else %}
...
{% endif %}
", "themes/etisalat/templates/common/field--field-menu-item.html.twig", "C:\\xampp\\htdocs\\drupal\\theming-etisalat\\themes\\etisalat\\templates\\common\\field--field-menu-item.html.twig");
    }
}
