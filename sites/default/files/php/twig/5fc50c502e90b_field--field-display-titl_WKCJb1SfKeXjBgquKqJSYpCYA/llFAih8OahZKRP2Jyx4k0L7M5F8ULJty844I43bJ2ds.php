...
/* themes/etisalat/templates/common/field--field-display-title.html.twig */
class __TwigTemplate_6ae92f8ed1520a6ee57309be39e410b81cb21e6ce6017bbd1ed35056c7130034 extends \Twig\Template
{
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 65
                    echo "      <div";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "field__item links-title accordion-menu"], "method")), "html", null, true);
                    echo ">";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "content", [])), "html", null, true);
                    echo "</div>
    ";
...
";
    ...
    {
        return "themes/etisalat/templates/common/field--field-display-title.html.twig";
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
      <div{{ attributes.addClass(classes, 'field__item links-title accordion-menu') }}>{{ item.content }}</div>
    {% endfor %}
  {% endif %}
{% else %}
...
{% endif %}
", "themes/etisalat/templates/common/field--field-display-title.html.twig", "C:\\xampp\\htdocs\\drupal\\theming-etisalat\\themes\\etisalat\\templates\\common\\field--field-display-title.html.twig");
    }
}
