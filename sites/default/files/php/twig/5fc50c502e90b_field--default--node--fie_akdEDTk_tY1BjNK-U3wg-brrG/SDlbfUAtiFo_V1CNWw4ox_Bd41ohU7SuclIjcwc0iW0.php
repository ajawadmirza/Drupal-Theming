...
/* themes/etisalat/templates/get-started/field--default--node--field-description--getting-started-steps.html.twig */
class __TwigTemplate_a2617d4178ddc68b9875c5c77ffbb5f1f13a834eb603c5df9afecf6de70741f3 extends \Twig\Template
{
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 65
                    echo "      <p";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "steps-content-description"], "method")), "html", null, true);
                    echo ">";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "content", [])), "html", null, true);
                    echo "</p>
    ";
...
";
    ...
    {
        return "themes/etisalat/templates/get-started/field--default--node--field-description--getting-started-steps.html.twig";
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
      <p{{ attributes.addClass(classes, 'steps-content-description') }}>{{ item.content }}</p>
    {% endfor %}
  {% endif %}
{% else %}
...
{% endif %}
", "themes/etisalat/templates/get-started/field--default--node--field-description--getting-started-steps.html.twig", "C:\\xampp\\htdocs\\drupal\\theming-etisalat\\themes\\etisalat\\templates\\get-started\\field--default--node--field-description--getting-started-steps.html.twig");
    }
}
