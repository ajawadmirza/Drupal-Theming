...
/* themes/etisalat/templates/get-started/field--default--node--field-step-heading--getting-started-steps.html.twig */
class __TwigTemplate_a2ce1a508df0219d584e3613fe630c995f5e0a2626e7d424c6d159b06cb31fc1 extends \Twig\Template
{
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 65
                    echo "      <h4";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "steps-content-title"], "method")), "html", null, true);
                    echo ">";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "content", [])), "html", null, true);
                    echo "</h4>
    ";
...
";
    ...
    {
        return "themes/etisalat/templates/get-started/field--default--node--field-step-heading--getting-started-steps.html.twig";
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
      <h4{{ attributes.addClass(classes, 'steps-content-title') }}>{{ item.content }}</h4>
    {% endfor %}
  {% endif %}
{% else %}
...
{% endif %}
", "themes/etisalat/templates/get-started/field--default--node--field-step-heading--getting-started-steps.html.twig", "C:\\xampp\\htdocs\\drupal\\theming-etisalat\\themes\\etisalat\\templates\\get-started\\field--default--node--field-step-heading--getting-started-steps.html.twig");
    }
}
