...
/* themes/etisalat/templates/get-started/field--block-content--field-sub-heading.html.twig */
class __TwigTemplate_51657b81d24157bb6c664dcaf579c79032b5b60fcf8335d2ca50d0229ed20409 extends \Twig\Template
{
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 65
                    echo "      <p";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "field__item etisalat-api-page-description"], "method")), "html", null, true);
                    echo ">";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "content", [])), "html", null, true);
                    echo "</p>
    ";
...
";
    ...
    {
        return "themes/etisalat/templates/get-started/field--block-content--field-sub-heading.html.twig";
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
      <p{{ attributes.addClass(classes, 'field__item etisalat-api-page-description') }}>{{ item.content }}</p>
    {% endfor %}
  {% endif %}
{% else %}
...
{% endif %}
", "themes/etisalat/templates/get-started/field--block-content--field-sub-heading.html.twig", "C:\\xampp\\htdocs\\drupal\\theming-etisalat\\themes\\etisalat\\templates\\get-started\\field--block-content--field-sub-heading.html.twig");
    }
}
