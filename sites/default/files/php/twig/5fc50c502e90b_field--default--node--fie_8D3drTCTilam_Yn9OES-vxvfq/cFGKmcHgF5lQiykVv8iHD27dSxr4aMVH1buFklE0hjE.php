...
/* themes/etisalat/templates/get-started/field--default--node--field-image--getting-started-steps.html.twig */
class __TwigTemplate_c95bf83072aa3d251e5075879f389d361dd42f406308b58d9ff13706604e3a33 extends \Twig\Template
{
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 65
                    echo "      <div";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "steps-icon"], "method")), "html", null, true);
                    echo ">";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "content", [])), "html", null, true);
                    echo "</div>
    ";
...
";
    ...
    {
        return "themes/etisalat/templates/get-started/field--default--node--field-image--getting-started-steps.html.twig";
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
      <div{{ attributes.addClass(classes, 'steps-icon') }}>{{ item.content }}</div>
    {% endfor %}
  {% endif %}
{% else %}
...
{% endif %}
", "themes/etisalat/templates/get-started/field--default--node--field-image--getting-started-steps.html.twig", "C:\\xampp\\htdocs\\drupal\\theming-etisalat\\themes\\etisalat\\templates\\get-started\\field--default--node--field-image--getting-started-steps.html.twig");
    }
}
