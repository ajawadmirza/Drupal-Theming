...
/* themes/etisalat/templates/get-started/field--default--node--field-url--getting-started-steps.html.twig */
class __TwigTemplate_1ebbc1e92f3501b38e35aa2a82e6ce520ffbf3e4d95ce05f15d3264565b22cb1 extends \Twig\Template
{
...
";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 65
                    echo "      <div";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "get-started-btn etisalat-api-primary-btn"], "method")), "html", null, true);
                    echo ">";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($context["item"], "content", [])), "html", null, true);
                    echo "</div>
    ";
...
";
    ...
    {
        return "themes/etisalat/templates/get-started/field--default--node--field-url--getting-started-steps.html.twig";
    }
...
{% if label_hidden %}
  ...
  {% else %}
    {% for item in items %}
      <div{{ attributes.addClass(classes, 'get-started-btn etisalat-api-primary-btn') }}>{{ item.content }}</div>
    {% endfor %}
  {% endif %}
{% else %}
...
{% endif %}
", "themes/etisalat/templates/get-started/field--default--node--field-url--getting-started-steps.html.twig", "C:\\xampp\\htdocs\\drupal\\theming-etisalat\\themes\\etisalat\\templates\\get-started\\field--default--node--field-url--getting-started-steps.html.twig");
    }
}
